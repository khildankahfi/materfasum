...
<div class="row justify-content-center">
    <div class="col-12 col-lg-7">
        <div class="bg-white rounded-2xl border border-slate-200/60 shadow-sm p-5">
            <div class="mb-5">
                <h5 class="font-extrabold text-slate-800 mb-1"><i class="bi bi-tags me-2 text-indigo-500"></i>Tambah Kategori Baru</h5>
                <p class="text-xs text-slate-400 font-semibold mb-0">Kategori digunakan warga saat melaporkan kerusakan fasilitas umum.</p>
            </div>
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <p class="text-[10px] text-slate-400 font-semibold mt-1.5 mb-0">Slug akan dibuat otomatis dari nama.</p>
                </div>
                ...
                <div>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="icon" id="iconInput" value="{{ old('icon', 'bi-tag') }}"
                ...
                <div>
                    ...
                    <textarea name="description" rows="3"
                              ...
                              placeholder="Penjelasan singkat tentang kategori ini (opsional)...">{{ old('description') }}</textarea>
                </div>
                ...
                <div class="d-flex gap-3 pt-2">
                    ...
                    <button type="submit" class="btn btn-primary rounded-xl px-5 py-2.5 text-xs font-bold flex-grow-1 shadow-sm shadow-indigo-500/10">
                        <i class="bi bi-plus-circle me-1.5"></i> Simpan Kategori
                    </button>
                </div>
            </form>
        </div>
